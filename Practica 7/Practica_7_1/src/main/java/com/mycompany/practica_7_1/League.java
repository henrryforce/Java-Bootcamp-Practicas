 ...
 */
package com.mycompany.practica_7_1;
    ...
    public static void main(String[] args){
        ...
        for(Player thePlayer:team2.arrayPlayer){
            if(thePlayer.playerName.matches(".*Sab.*")) {
                System.out.println("Fount "+thePlayer.playerName);
                System.out.println("Lastname is " + thePlayer.playerName.split(" ")[1]);
            }
        }
        StringBuilder familyNameFirst =new StringBuilder();
        System.out.println("Team 1 display names");
